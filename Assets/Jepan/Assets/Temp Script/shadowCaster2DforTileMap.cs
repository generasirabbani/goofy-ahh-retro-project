...
public class shadowCaster2DforTileMap : MonoBehaviour
{
	[SerializeField]
...
#if UNITY_EDITOR
[CustomEditor(typeof(shadowCaster2DforTileMap))]
public class shadowCaster2DforTileMapEditor : Editor
{
	public override void OnInspectorGUI()
	{
		...
		{
			var creator = (shadowCaster2DforTileMap)target;
			creator.Create();
		}
